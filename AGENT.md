# Ensign Application — open-application

**Repo:** SuperInstance/open-application

## Who I Am

I watch over open-application. Build smaller, faster, and more secure desktop and mobile applications with a web frontend.
